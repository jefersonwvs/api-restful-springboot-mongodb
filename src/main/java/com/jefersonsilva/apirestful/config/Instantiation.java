package com.jefersonsilva.apirestful.config;
...
import com.jefersonsilva.apirestful.dto.AuthorDTO;
import com.jefersonsilva.apirestful.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... arg0) throws Exception {
		...
		CommentDTO comment1 = new CommentDTO("Boa viagem, amigo!", sdf.parse("21/03/2018"), new AuthorDTO(alex));
